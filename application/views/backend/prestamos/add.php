                        ...
                        <tbody>
                            ...
                            <?php foreach ($libros as $libro): ?>
                                <tr>
                                    ...
                                    <?php if ($disponibles == 0): ?>
                                        <td><button type="button" class="btn btn btn-sm" disabled="disabled"><i  aria-hidden="true"></i> Seleccionar</button></td>

                                    <?php else: ?>
                                        <td><button type="button" class="btn btn btn-sm btn-select" value="<?php echo $libro->id_libro ?>" data-toggle="modal" data-target="#myModal" ><i class="fa fa-check" aria-hidden="true"></i> Seleccionar</button></td>
                                    <?php endif;?>
                                </tr>
                                <?php $i++;?>
                            <?php endforeach;?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <button type="button" id="btn-comprobardni" class="btn btn btn-flat"> <i  aria-hidden="true"></i> Comprobar</button>
                    <a href="<?php echo base_url(); ?>backend/lectores/add" class="btn btn btn-flat"><i  aria-hidden="true"></i> Registrar</a>
