...
<body>
    <div class="content">
        <div class="header">
            <h1>Sistema bibliotecario de League of Legends</h1>
        </div>
            ...
            <div class="row">
                <form class="form-horizontal form-search" action="<?php echo base_url(); ?>frontend/principal/search" method="GET">
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="codtitulo" class="form-control" value="<?php echo $this->session->flashdata("codtitulo") == true ? $this->session->flashdata("codtitulo") : '' ?>" placeholder="nombre o codigo">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo base_url(); ?>frontend/principal/search" class="btn btn-danger btn-block"><i class="fa fa-eye" aria-hidden="true"></i> Todos los Libros</a>
                        </div>
                    </div>
                </form>
            </div>
           ...
           //alert(idlibro);
                ...
                $.ajax({
                    ...
                    if (msg) {
                       ...
                       $("img.imagen").attr("src","http://localhost/sistemabiblioteca"+ result.imagen_libro);
                    }else{
                        alert("error");
                    }
